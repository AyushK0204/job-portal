...
const Footer = () => {
  return (
    <div className="container px-4 2xl:px-20 mx-auto flex items-center justify-between gap-4 py-3 mt-20 bg-gradient-to-t from-orange-200 to-white dark:from-gray-600 dark:to-black dark:text-white">
